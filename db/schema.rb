...
ActiveRecord::Schema[7.1].define(version: 20_240_528_174_300) do
  ...
  create_table 'products_type_products', id: false, force: :cascade do |t|
    ...
    t.index %w[type_product_id product_id], name: 'index_products_type_products_on_type_product_id_and_product_id',
                                            unique: true
  end
